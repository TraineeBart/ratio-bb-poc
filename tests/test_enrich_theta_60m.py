...
# ╭──────────────────────────────────────────────────────────────╮
# │ File: tests/test_enrich_theta_60m.py                         │
# │ Module: Enrichment Test                                      │
# │ Doel: Basisvalidatie van de verrijkte 60m theta dataset     │
...
def test_theta_60m_enriched_structure():
    """
    ✅ Verifieert de kolomstructuur van de verrijkte 60m theta dataset.
    """
    file_path = Path("/opt/tradingbot/data/enriched/theta/60m/theta-60m-enriched.csv")
...
def test_theta_60m_enriched_no_nans_or_infs():
    """
...
def test_theta_60m_enriched_min_length():
    """
